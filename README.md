...
| [Qwen3.8 27B NVFP4 DGX Spark Recipe](https://github.com/sojufx/Qwen3.8-27B-NVFP4-DGX-Spark-Recipe) | new Qwen coding / multimodal-capable agent experiments | 262K | vLLM 0.27.2, built-in MTP K=3, FP8 KV, FlashInfer cubin fix, thinking/tool parser notes |
